# Contributing to the Add to Calendar Button Vue Repository
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/add-to-calendar-button-vue.git
    # Navigate to the newly cloned directory
    cd add-to-calendar-button-vue
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/add2cal/add-to-calendar-button-vue.git
    ```
